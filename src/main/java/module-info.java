module net.filebot {
  ...
  opens net.filebot to
      javafx.fxml,
      javafx.graphics;
  opens net.filebot.ui to
      javafx.fxml,
      javafx.graphics,
      com.google.common;
  opens net.filebot.ui.rename to
      javafx.fxml,
      javafx.graphics,
      com.google.common;
  opens net.filebot.ui.episodelist to
      javafx.fxml,
      javafx.graphics,
      com.google.common;
  opens net.filebot.ui.subtitle to
      javafx.fxml,
      javafx.graphics,
      com.google.common;
  opens net.filebot.ui.filter to
      javafx.fxml,
      javafx.graphics,
      com.google.common;
  opens net.filebot.ui.list to
      javafx.fxml,
      javafx.graphics,
      com.google.common;
  opens net.filebot.ui.sfv to
      javafx.fxml,
      javafx.graphics,
      com.google.common;

  // Open packages for Groovy scripting reflection
  opens net.filebot.cli to
      org.apache.groovy,
      org.apache.groovy.jsr223;
  opens net.filebot.format to
      org.apache.groovy;

  // Open packages for JSON serialization/deserialization
  opens net.filebot.web to
      json.io;
