...
class ArchiveOpenVolumeCallback
  ...
  /**
   * The name of the required volume will be calculated out of the name of the first volume and a
   * volume index. In case of RAR file, the substring ".partNN." in the name of the volume file will
   * indicate a volume with id NN. For example:
   *
   * <ul>
   *   <li>test.rar - single part archive or multi-part archive with a single volume
   *   <li>test.part23.rar - 23-th part of a multi-part archive
   *   <li>test.part001.rar - first part of a multi-part archive. "00" indicates, that at least 100
   *       volumes must exist.
   * </ul>
   */
  @Override
