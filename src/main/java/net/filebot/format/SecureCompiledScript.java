...
public class SecureCompiledScript extends CompiledScript {
  ...
  public static PermissionCollection getDefaultSandboxPermissions() {
    ...
    // give up on real security, just try to keep files read-only (because of classloading and
    // native lib loading issues)
  ...
  public SecureCompiledScript(CompiledScript compiledScript) {
    this(
        ...
        new AccessControlContext(
            new ProtectionDomain[] {new ProtectionDomain(null, getDefaultSandboxPermissions())}));
  }
  ...
  public Object eval(ScriptContext context) throws ScriptException {
    try {
      ...
      AccessControlException accessException =
          ExceptionUtilities.findCause(e, AccessControlException.class);

      // try to unwrap AccessControlException
      if (accessException != null) throw new ExpressionException(accessException);
