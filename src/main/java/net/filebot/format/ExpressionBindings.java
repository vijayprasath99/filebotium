...
public class ExpressionBindings extends AbstractMap<String, Object> implements Bindings {
  ...
  protected final Map<String, Method> bindings =
      new TreeMap<String, Method>(String.CASE_INSENSITIVE_ORDER);
        ...
        for (String name : define.value()) {
          ...
          if (existingBinding != null) {
            throw new IllegalArgumentException(
                String.format("Illegal binding {%s} on %s", name, method.getName()));
          }
        }
      }
    }
