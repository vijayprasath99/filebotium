...
interface MediaInfoLibrary extends Library {
  ...
  // libmediainfo for linux depends on libzen, so we need to load dependencies first, because we
  // know where our native libs are (e.g. Java Web Start Cache).
   ...
   * @param parameter Parameter you are looking for in the stream (Codec, width, bitrate...), in
   *     string format ("Codec", "Width"...)
   * @param infoKind Kind of information you want about the parameter (the text, the measure, the
   *     help...)
   ...
   * @param streamNumber Stream number in Kind of stream (first, second...)
   * @param parameter Parameter you are looking for in the stream (Codec, width, bitrate...), in
   *     integer format (first parameter, second parameter...)
   * @param infoKind Kind of information you want about the parameter (the text, the measure, the
   *     help...)
   * @return a string about information you search, an empty string if there is a problem
   */
