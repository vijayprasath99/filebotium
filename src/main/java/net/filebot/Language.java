...
public class Language implements Serializable {
  ...
  public Language(
      String iso_639_1, String iso_639_3, String iso_639_2B, String tag, String[] names) {
  ...
  public boolean matches(String code) {
    return Stream.concat(Stream.of(iso_639_1, iso_639_2B, iso_639_3, tag), Stream.of(names))
  ...
  public static final Comparator<Language> ALPHABETIC_ORDER =
      comparing(Language::getName, String::compareToIgnoreCase);
