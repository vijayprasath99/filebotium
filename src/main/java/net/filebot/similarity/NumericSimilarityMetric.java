...
public class NumericSimilarityMetric implements SimilarityMetric {
  ...
  private final StringMetric metric =
      with(new BlockDistance<String>()).tokenize(new NumberTokeniser()).build();
  ...
  protected String normalize(Object object) {
    // no need to do anything special here, because we don't care about anything but number patterns
    // anyway
