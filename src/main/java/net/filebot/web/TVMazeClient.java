...
public class TVMazeClient extends AbstractEpisodeListProvider {
  ...
  public List<SearchResult> fetchSearchResult(String query, Locale locale) throws Exception {
    ...
    // FUTURE WORK: consider adding TVmaze aka titles for each result, e.g.
    // http://api.tvmaze.com/shows/1/akas
  ...
  protected SeriesInfo fetchSeriesInfo(SearchResult show, SortOrder sortOrder, Locale locale)
      throws Exception {
  ...
  @Override
  protected SeriesData fetchSeriesData(
