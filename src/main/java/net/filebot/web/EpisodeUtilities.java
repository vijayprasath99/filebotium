...
public final class EpisodeUtilities {
  ...
  public static boolean isAbsolute(Episode e) {
    return e.getAbsolute() != null
        && e.getSeriesInfo().getOrder() != null
        && SortOrder.Absolute == SortOrder.valueOf(e.getSeriesInfo().getOrder());
  }
  ...
  public static List<Episode> fetchEpisodeList(
      Episode episode, SortOrder preferredSortOrder, Locale preferredLocale) throws Exception {
  ...
  public static Episode fetchEpisode(
      Episode episode, SortOrder preferredSortOrder, Locale preferredLocale) throws Exception {
    ...
    return createEpisode(
        episodeList.stream()
            ...
            .sorted(EPISODE_NUMBERS_COMPARATOR)
            .collect(toList()));
  }

  public static Episode getEpisodeByAbsoluteNumber(
      Episode e, EpisodeListProvider service, SortOrder order) throws Exception {
    ...
    for (SearchResult series : service.search(e.getSeriesName(), locale)) {
      ...
      List<Episode> airdateEpisode =
          multiEpisode.stream()
              .flatMap(
                  abs -> {
                    return airdateEpisodeList.stream()
                        .filter(sxe -> abs.getSpecial() == null && sxe.getSpecial() == null)
                        .filter(
                            sxe -> {
                              return abs.getAbsolute() != null
                                  && abs.getAbsolute().equals(sxe.getAbsolute());
                            });
                  })
              .collect(toList());
  ...
  public static final Comparator<Episode> EPISODE_NUMBERS_COMPARATOR =
