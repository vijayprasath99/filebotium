...
public class SubtitleSearchResult extends Movie {
  ...
  public enum Kind {
    ...
    public static Kind forName(String s) {
      if (s == null || s.isEmpty()) return Unkown;
      else if (s.equalsIgnoreCase("m") || s.equalsIgnoreCase("movie")) return Movie;
      if (s.equalsIgnoreCase("s") || s.equalsIgnoreCase("tv series")) return Series;
      else return Other;
    }
  }
