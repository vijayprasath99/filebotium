...
/**
 * Fast name matcher used for matching a file to or more movies (out of a list of ~50k in
 * milliseconds)
 */
class HighPerformanceMatcher extends CommonSequenceMatcher {
  ...
  public static List<IndexEntry<SearchResult>> prepare(SearchResult r) {
    ...
    List<IndexEntry<SearchResult>> index =
        new ArrayList<IndexEntry<SearchResult>>(effectiveNames.size());
