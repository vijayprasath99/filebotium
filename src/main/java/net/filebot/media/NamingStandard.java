...
public class NamingStandard {
   ...
   *
   * <p>https://support.plex.tv/articles/categories/media-preparation/
   */
  public static final NamingStandard PLEX = new NamingStandard();

  /**
   * Kodi Naming Standard (i.e. same as Plex, but with SxE and non-range based multi-episode
   * formatting)
   *
   * <p>https://kodi.wiki/view/Naming_video_files
   */
  public static final NamingStandard KODI =
      new NamingStandard() {
  ...
  public String getPath(Object o) {
    if (o instanceof Episode) return getPath((Episode) o);
    if (o instanceof Movie) return getPath((Movie) o);
    if (o instanceof AudioTrack) return getPath((AudioTrack) o);
  ...
  public String formatEpisodeTitle(Episode e) {
    ...
    return truncateText(
        EpisodeFormat.SeasonEpisode.formatMultiTitle(getMultiEpisodeList(e)), TITLE_MAX_LENGTH);
  }
