...
public class LanguageComboBoxCellRenderer implements ListCellRenderer {
  ...
  public Component getListCellRendererComponent(
    ...
    JLabel c =
        (JLabel) base.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
    ...
    if (index == 0 || index == model.favorites().size()) {
      ...
      c.setBorder(
          new CompoundBorder(
              new DashedSeparator(10, 4, Color.lightGray, list.getBackground()), c.getBorder()));
    }
