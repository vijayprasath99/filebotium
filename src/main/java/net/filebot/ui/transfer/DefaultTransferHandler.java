...
public class DefaultTransferHandler extends TransferHandler {
  ...
  public DefaultTransferHandler(
      TransferablePolicy transferablePolicy, TransferableExportHandler exportHandler) {
    this(transferablePolicy, exportHandler, new DefaultClipboardHandler());
  }

  public DefaultTransferHandler(
      TransferablePolicy transferablePolicy,
      TransferableExportHandler exportHandler,
  ...
  public boolean canImport(TransferSupport support) {
    ...
    if (transferablePolicy != null) return transferablePolicy.canImport(support);
  ...
  protected void exportDone(JComponent source, Transferable data, int action) {
    ...
    if (exportHandler != null) exportHandler.exportDone(source, data, action);
  }

  @Override
  public int getSourceActions(JComponent c) {
    if (exportHandler != null) return exportHandler.getSourceActions(c);
  ...
  protected Transferable createTransferable(JComponent c) {
    ...
    if (exportHandler != null) return exportHandler.createTransferable(c);
  ...
  public void exportToClipboard(JComponent comp, Clipboard clip, int action)
    ...
    if (clipboardHandler != null) clipboardHandler.exportToClipboard(comp, clip, action);
  }
