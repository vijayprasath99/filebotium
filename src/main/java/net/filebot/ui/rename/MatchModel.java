...
public class MatchModel<Value, Candidate> {
  ...
  private final EventList<Match<Value, Candidate>> source =
      new BasicEventList<Match<Value, Candidate>>();
  ...
  public MatchModel() {
    this.values =
        new MatchView<Value, Candidate>(source) {
    ...
    this.candidates =
        new MatchView<Candidate, Value>(source) {
