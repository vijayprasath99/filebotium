...
class ExpressionFormatter implements MatchFormatter {
  ...
  public boolean canFormat(Match<?, ?> match) {
    ...
    return target.isInstance(match.getValue())
        && (match.getCandidate() == null || match.getCandidate() instanceof File);
  }
  ...
  @Override
  public synchronized String format(Match<?, ?> match, boolean extension, Map<?, ?> context)
    ...
    Object bindingBean =
        new MediaBindingBean(match.getValue(), (File) match.getCandidate(), (Map) context);
