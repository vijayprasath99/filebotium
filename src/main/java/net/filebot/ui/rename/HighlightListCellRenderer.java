...
class HighlightListCellRenderer extends AbstractFancyListCellRenderer {
  ...
  public HighlightListCellRenderer(
      Pattern pattern, Highlighter.HighlightPainter highlightPainter, int padding) {
    ...
    // make text component transparent, should work for all LAFs (setOpaque(false) may not, e.g.
    // Nimbus)
