...
class LanguageRenderer implements TableCellRenderer, ListCellRenderer {
  ...
  private Component configure(
      JLabel c, JComponent parent, Object value, boolean isSelected, boolean hasFocus) {
    if (value != null) {
  ...
  public Component getTableCellRendererComponent(
    ...
    return configure(
        (DefaultTableCellRenderer)
            tableCell.getTableCellRendererComponent(
  ...
  public Component getListCellRendererComponent(
    ...
    return configure(
        (DefaultListCellRenderer)
            listCell.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus),
        list,
        value,
        isSelected,
        cellHasFocus);
