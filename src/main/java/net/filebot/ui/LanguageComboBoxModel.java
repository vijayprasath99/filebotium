...
public class LanguageComboBoxModel extends AbstractListModel implements ComboBoxModel {
  ...
  public static final Language ALL_LANGUAGES =
      new Language("undefined", "und", "und", "und", new String[] {"All Languages"});
  ...
  public Language getElementAt(int index) {
    // "All Languages"
    if (index == 0) return defaultLanguage;
  ...
  private class Favorites extends AbstractList<Language> {
    ...
    public boolean addIfAbsent(int index, Language element) {
      ...
      if (element == null
          || element == ALL_LANGUAGES
          || element.getCode().equals(defaultLanguage.getCode())
          || contains(element)
          || index >= capacity) {
        return false;
      }
    ...
    public boolean contains(Object obj) {
      ...
      if (obj instanceof Language) {
        ...
        for (Language element : data) {
          if (language.getCode().equals(element.getCode())) return true;
        }
      }
