...
class TotalProgressPanel extends JComponent {
  ...
  private final PropertyChangeListener progressListener =
      new PropertyChangeListener() {
          ...
          SwingUtilities.invokeLater(
              () -> {
                if (completedTaskCount == totalTaskCount) {
                  ...
                  delayed.toggle(
                      HIDE, totalTaskCount == 0 ? millisToSetVisible : 0, visibilityActionHandler);
                ...
                if (totalTaskCount != 0) {
                  ...
                  progressBar.setString(
                      String.format("%d / %d", completedTaskCount, totalTaskCount));
                }
              });
        }
        ...
        private final ActionListener visibilityActionHandler =
            new ActionListener() {
