...
class HighlightPatternCellRenderer extends DefaultTableCellRenderer {
  ...
  public Component getTableCellRendererComponent(
    ...
    // do not change the font-color if cell is selected, because that would look ugly (imagine green
    ...
    while (matcher.find()) {
      matcher.appendReplacement(
          htmlText,
          createReplacement(
              isSelected ? null : isError ? "red" : "#009900", "smaller", isError ? "bold" : null));
    }
