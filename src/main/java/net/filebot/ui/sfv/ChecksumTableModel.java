...
class ChecksumTableModel extends AbstractTableModel {
  ...
  private final IndexedMap<String, ChecksumRow> rows =
      new IndexedMap<String, ChecksumRow>() {
  ...
  protected abstract static class IndexedMap<K, V> extends AbstractList<V> {
