...
public class FileBotList<E> extends JComponent {
  ...
  public FileBotList() {
    ...
    SwingUI.installAction(
        this, KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, KeyEvent.ALT_DOWN_MASK), removeHook);
  }
  ...
  private final AbstractAction defaultRemoveAction =
  ...
  private final AbstractAction removeHook =
      new AbstractAction("Remove") {
