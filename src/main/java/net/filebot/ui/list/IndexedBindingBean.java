...
public class IndexedBindingBean extends MediaBindingBean {
  ...
  private static Map<File, Object> getContext(List<?> context) {
    List<Object> values =
        new FunctionList<Object, Object>((List<Object>) context, IndexedBindingBean::getInfoObject);
    List<File> files =
        new FunctionList<Object, File>((List<Object>) context, IndexedBindingBean::getMediaFile);
