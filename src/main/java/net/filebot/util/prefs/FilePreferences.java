...
public class FilePreferences extends AbstractPreferences {
  ...
  public void sync() throws BackingStoreException {
    // if the backing store naturally syncs an entire subtree at once, the implementer is encouraged
    // to override sync(), rather than merely overriding syncSpi()
    syncSpi();
  }
  ...
  public void flush() throws BackingStoreException {
    // if the backing store naturally flushes an entire subtree at once, the implementer is
    // encouraged to override flush(), rather than merely overriding flushSpi()
    flushSpi();
  }
