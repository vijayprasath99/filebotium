...
public class LoadingOverlayPane extends JComponent {
  ...
  public LoadingOverlayPane(
      JComponent component, JComponent propertyChangeSource, String offsetX, String offsetY) {
    ...
    add(
        ...
        String.format(
            "pos n %s 100%%-%s n",
            offsetY != null ? offsetY : "8px", offsetX != null ? offsetX : "20px"));
    add(component, "grow");
