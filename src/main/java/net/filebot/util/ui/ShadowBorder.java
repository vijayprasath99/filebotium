...
public class ShadowBorder extends AbstractBorder {
  ...
  public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
    ...
    g2d.setPaint(
        CornerGradientStyle.BOTTOM_RIGHT.getGradientPaint(bottomRightCorner, a, bg, faded));
  ...
  private static enum CornerGradientStyle {
    ...
    public RadialGradientPaint getGradientPaint(
        RectangularShape shape, float radius, Color gradientBeginColor, Color gradientEndColor) {
      Point2D center = null;
