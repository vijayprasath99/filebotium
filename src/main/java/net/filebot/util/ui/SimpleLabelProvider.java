...
public class SimpleLabelProvider<T> implements LabelProvider<T> {
  ...
  /**
   * Create a new LabelProvider which will use the <code>getText</code>, <code>getName</code> or
   * <code>toString</code> method for text and the <code>getIcon</code> method for the icon.
   *
